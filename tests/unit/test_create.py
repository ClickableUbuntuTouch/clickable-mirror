...
class TestCreateCommand(UnitTest):
    ...
    def test_create_interactive(self, mock_cookiecutter):
        ...
        self.command.run()
        mock_cookiecutter.assert_called_with(ANY,
                extra_context={'Copyright Year': ANY}, no_input=False, config_file=ANY,
                output_dir=ANY)
    ...
    def test_create_non_interactive(self, mock_cookiecutter):
        ...
        self.command.run()
        mock_cookiecutter.assert_called_with(ANY,
                extra_context={'Copyright Year': ANY}, no_input=True, config_file=ANY,
                output_dir=ANY)
